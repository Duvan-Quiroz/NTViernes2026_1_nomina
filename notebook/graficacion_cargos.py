...
def graficar_lineas(datos_agrupados, columna_eje_x, columna_eje_y,
    ...
    # Útil para mostrar tendencias, por ejemplo valores de cargos a lo largo del tiempo
...
def graficar_barras(datos_agrupados, columna_categorias, columna_valores,
    ...
    # Útil para comparar cantidades, por ejemplo cargos por categoría
...
def graficar_torta(datos_agrupados, columna_etiquetas, columna_valores,
    ...
    # Útil para mostrar proporciones, por ejemplo distribución de tipos de cargos
...
def graficar_mapa_calor(datos_agrupados, columna_filas, columna_columnas, columna_valores,
    ...
    # Útil para comparar dos variables, por ejemplo monto de cargos por categoría y mes
