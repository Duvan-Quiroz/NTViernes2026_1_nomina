...
def transformar_datos(data_frame_limpio):
    ...
    # Transformación 1 (conteo de bonificaciones por id)
    filtro1 = data_frame_limpio
    agrupacion1 = filtro1.groupby("id")["valor"].count().reset_index(name="cantidad_bonificaciones")
    ...
    # Transformación 3 (bonificaciones con valor alto >300)
    filtro3 = data_frame_limpio.query("valor > 300")
